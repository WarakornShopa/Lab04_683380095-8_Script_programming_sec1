...
point1 = (_ ,  _) #เติมพิกัด x y ของจุด 👈ต้องทำ
point2 = (_, _)  #เติมพิกัด x y ของจุด 👈ต้องทำ

# 2) เข้าถึงค่าพิกัด x, y ของแต่ละจุด
print("\n[1] Access Coordinates")
print(f"Point 1: x = {point1[_]}, y = {point1[_]}") #เติมเลข 0 และ 1 ใน [] 👈ต้องทำ
print(f"Point 2: x = {point2[_]}, y = {point2[_]}") #เติมเลข 0 และ 1 ใน [] 👈ต้องทำ
...
distance = math.sqrt((point2[_] - point1[_]) ** 2 + (point2[_] - point1[_]) ** 2) #เติมเลขตำแหน่งในลิส 0 และ 1 ใน [] ให้ถูกต้อง 👈ต้องทำ
